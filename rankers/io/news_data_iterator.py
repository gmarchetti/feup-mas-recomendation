...
class NewsDataIterator(BaseIterator):
    ...
    def init_news(self, news_file):
        ...
        with tf.io.gfile.GFile(news_file, "r") as rd:
            for line in rd:
                ...
                self.news_topics_index.append([vert, subvert])
    ...
    def get_user_history(self, uindex):
        return self.histories[uindex]
    
    def get_news_topics(self, news_index):
        return self.news_topics_index[news_index]
    ...
    def parser_one_line(self, line):
        ...
        Yields:
            ...
            candidate_title_index, candidate_topic_index, clicked_title_index and clicked_topics_index
        """
        if self.npratio > 0:
            ...
            for p in poss:
                ...
                candidate_topic_index = self.news_topics_index[[p] + n]
                click_title_index = self.news_title_index[self.histories[line]]
                clicked_topics_index = self.news_topics_index[self.histories[line]]
                ...
                yield (
                    ...
                    click_title_index,
                    clicked_topics_index
                )

        else:
            impr_label = self.labels[line]
            impr = self.imprs[line]
            print(self.npratio, line)
            for news, label in zip(impr, impr_label):
                ...
                candidate_topic_index.append(self.news_topics_index[news])
                click_title_index = self.news_title_index[self.histories[line]]
                clicked_topics_index = self.news_topics_index[self.histories[line][0]]
                impr_index.append(self.impr_indexes[line])
                user_index.append(self.uindexes[line])
    ...
    def load_user_from_file(self, news_file, behavior_file):
        ...
        Args:
            ...
            behaviors_file (str): A file contains information of user impressions.
    ...
    def load_impression_from_file(self, behaviors_file):
        ...
        Args:
            behaviors_file (str): A file contains several information of behaviors.
